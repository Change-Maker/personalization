...
function config_nvimtree() {
  ...
  write_plugin_config '  vim.keymap.set("n", "y", api.fs.copy.node, opts("Copy"))'
  write_plugin_config '  vim.keymap.set("n", "c", api.fs.copy.filename, opts("Copy Name"))'
...
function config_hop() {
  ...
  write_plugin_config 'vim.keymap.set("n", "\\\\s", "<CMD>HopChar1<CR>", { desc = "Search character" })'
  write_plugin_config 'vim.keymap.set("n", "\\\\S", "<CMD>HopChar2MW<CR>", { desc = "Search characters overwin" })'
  write_plugin_config 'vim.keymap.set("n", "\\\\/", "<CMD>HopPatternMW<CR>", { desc = "Search n-character overwin" })'
  write_plugin_config 'vim.keymap.set("n", "\\\\w", "<CMD>HopWordAC<CR>", { desc = "Search word forward" })'
  write_plugin_config 'vim.keymap.set("n", "\\\\b", "<CMD>HopWordBC<CR>", { desc = "Search word backward" })'
  write_plugin_config 'vim.keymap.set("n", "\\\\j", "<CMD>HopLineAC<CR>", { desc = "Search line forward" })'
  write_plugin_config 'vim.keymap.set("n", "\\\\k", "<CMD>HopLineBC<CR>", { desc = "Search line backward" })'
  write_plugin_config ''
}
